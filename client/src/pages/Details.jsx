                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        <div>
                            <div className='p-5 border'>
                                <img className='h-[500px] w-full' src={image ? image : product.images?.[0]} alt="fetched" />
                            </div>
                            <div className='py-3'>
                                {
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex gap-3 pb-10 border-b'>
                                {
                                    product.stock ? <>
                                        ...
                                        <div>
                                            <button onClick={add_card} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-[#72A0AE] text-white'>Add To Card</button>
                                        </div>
                                    </> : ''
                                }
                                <div>
                                    <div onClick={add_wishlist} className='h-[50px] w-[50px] flex justify-center items-center cursor-pointer hover:shadow-lg hover:shadow-cyan-500/40 bg-[#72A0AE] text-white'>
                                        <AiFillHeart />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='flex gap-3'>
                                {
                                    product.stock ? <button onClick={buy} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-emerald-500/40  bg-[#384B50] text-white'>Buy Now</button> : ""
                                }
                                <Link to={`/dashboard/chat/${product.sellerId}`} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-lime-500/40 bg-[#72A0AE] text-white block'>Chat Seller</Link>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className='w-[72%] md-lg:w-full'>
                            <div className='pr-4 md-lg:pr-0'>
                                <div className='grid grid-cols-2'>
                                    <button onClick={() => setState('reviews')} className={`py-1 hover:text-white px-5 hover:bg-green-500 ${state === 'reviews' ? ' bg-[#72A0AE] text-white' : 'bg-slate-200 text-slate-700'} rounded-sm`}>Reviews</button>
                                    <button onClick={() => setState('description')} className={`py-1 px-5 hover:text-white hover:bg-green-500 ${state === 'description' ? 'bg-[#72A0AE] text-white' : 'bg-slate-200 text-slate-700'} rounded-sm`}>Description</button>
                                </div>
                                <div>
                                    {
                                            ...
                                            return (
                                                <Link className='block'>
                                                    ...
                                                    <div className='flex gap-2'>
                                                        <h2 className='text-[#6699ff] text-lg font-bold'>Rs.{p.price}</h2>
