                                ...
                                <div className="bg-white p-6 shadow-sm rounded-md">
                                            ...
                                            <form onSubmit={save}>
                                                ...
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    ...
                                                    <div className='flex flex-col gap-1 mt-3 w-full'>
                                                        <button className='px-3 py-[6px] rounded-sm hover:shadow-indigo-500/20 hover:shadow-lg bg-[#72A0AE] text-white'>Save</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </>
                                    }
                                    {
                                        res && <div className='flex flex-col gap-1'>
                                            ...
                                            <p className='text-slate-600 text-sm'>Email to nexusnet@gmail.com</p>
                                        </div>
                                    }
                                </div>
                                {
                        ...
                        <div className='w-[33%] md-lg:w-full'>
                            <div className="pl-3 md-lg:pl-0">
                                <div className='bg-white font-medium p-5 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <button onClick={placeOrder} disabled={res ? false : true} className={`px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg ${res ? 'bg-orange-500' : 'bg-[#72A0AE]'} text-sm text-white uppercase`}>Place Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
